...
import { Calculator, Brain, Trophy, Clock, Users, CheckCircle2, ArrowRight, Target, Zap, Eye, TrendingUp, Focus } from "lucide-react";
import { ImageWithFallback } from "./figma/ImageWithFallback";
import { PricingTiers } from "./pricing-tiers";
export function AbacusProgramPage({ onNavigate }) {
    const levels = [
        {
    ...
    return (_jsxs("div", { className: "min-h-screen bg-white", children: [_jsxs("section", { className: "relative py-20 bg-gradient-to-br from-green-600 via-blue-600 to-purple-700 text-white overflow-hidden", children: [_jsxs("div", { className: "absolute inset-0 opacity-10", children: [_jsx("div", { className: "absolute top-10 left-10 w-72 h-72 bg-white rounded-full blur-3xl" }), _jsx("div", { className: "absolute bottom-10 right-10 w-96 h-96 bg-orange-300 rounded-full blur-3xl" })] }), _jsx("div", { className: "container mx-auto px-4 relative z-10", children: _jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: [_jsxs(motion.div, { initial: { opacity: 0, x: -50 }, animate: { opacity: 1, x: 0 }, transition: { duration: 0.6 }, children: [_jsx(Badge, { className: "mb-4 bg-white/20 text-white border-white/30 px-4 py-1", children: "Ancient Wisdom, Modern Results" }), _jsx("h1", { className: "text-4xl md:text-6xl mb-6 font-clash", children: "Abacus Training" }), _jsx("p", { className: "text-xl mb-8 text-blue-100 leading-relaxed", children: "Unlock your child's mental superpowers with abacus! Watch them calculate faster than a calculator while developing concentration, memory, and visualization skills that last a lifetime." }), _jsxs("div", { className: "flex flex-wrap gap-4 mb-8", children: [_jsxs("div", { className: "flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2", children: [_jsx(Clock, { className: "w-5 h-5" }), _jsx("span", { children: "2 Classes/Week" })] }), _jsxs("div", { className: "flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2", children: [_jsx(Users, { className: "w-5 h-5" }), _jsx("span", { children: "Small Batches (Max 8)" })] }), _jsxs("div", { className: "flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2", children: [_jsx(Trophy, { className: "w-5 h-5" }), _jsx("span", { children: "Competition Training" })] })] }), _jsxs("div", { className: "flex gap-4", children: [_jsxs(Button, { size: "lg", onClick: () => {
                                                        const pricingSection = document.querySelector('.pricing-section');
                                                        if (pricingSection) {
                                                            pricingSection.scrollIntoView({ behavior: 'smooth' });
                                                        }
                                                    }, className: "bg-orange-500 hover:bg-orange-600 text-white rounded-full px-8", children: ["View Pricing", _jsx(ArrowRight, { className: "w-5 h-5 ml-2" })] }), _jsx(Button, { size: "lg", variant: "outline", className: "rounded-full px-8 border-2 border-white text-[rgb(0,0,0)] hover:bg-white/10", onClick: () => onNavigate?.("contact"), children: "Enroll Now" })] })] }), _jsxs(motion.div, { className: "relative", initial: { opacity: 0, x: 50 }, animate: { opacity: 1, x: 0 }, transition: { duration: 0.6 }, children: [_jsxs("div", { className: "relative rounded-3xl overflow-hidden shadow-2xl", children: [_jsx(ImageWithFallback, { src: "https://images.unsplash.com/photo-1718306201865-cae4a08311fe?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjaGlsZHJlbiUyMGxlYXJuaW5nJTIwbWF0aGVtYXRpY3MlMjBhYmFjdXN8ZW58MXx8fHwxNzYwMjUzODIwfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral", alt: "Kids learning abacus", className: "w-full h-[500px] object-cover" }), _jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-green-900/50 to-transparent" })] }), _jsx(motion.div, { className: "absolute -bottom-6 -left-6 bg-white rounded-2xl shadow-xl p-6", animate: { y: [0, -10, 0] }, transition: { duration: 3, repeat: Infinity }, children: _jsxs("div", { className: "flex items-center gap-4", children: [_jsx("div", { className: "bg-green-100 p-3 rounded-xl", children: _jsx(Brain, { className: "w-8 h-8 text-green-600" }) }), _jsxs("div", { children: [_jsx("div", { className: "text-2xl text-gray-900 font-clash", children: "10x" }), _jsx("div", { className: "text-sm text-gray-600", children: "Faster Calculations" })] })] }) })] })] }) })] }), _jsx("section", { className: "py-12 bg-white border-b", children: _jsx("div", { className: "container mx-auto px-4", children: _jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-8", children: achievements.map((stat, index) => (_jsxs(motion.div, { className: "text-center", initial: { opacity: 0, y: 20 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.5, delay: index * 0.1 }, viewport: { once: true }, children: [_jsx("div", { className: "text-3xl md:text-4xl text-green-600 mb-2 font-clash", children: stat.value }), _jsx("div", { className: "text-sm text-gray-600", children: stat.label })] }, index))) }) }) }), _jsx("section", { className: "py-16 bg-gray-50", children: _jsxs("div", { className: "container mx-auto px-4", children: [_jsxs(motion.div, { className: "text-center max-w-3xl mx-auto mb-12", initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.6 }, viewport: { once: true }, children: [_jsxs("h2", { className: "text-3xl md:text-4xl mb-4 text-gray-900 font-clash", children: ["The Power of ", _jsx("span", { className: "text-green-600", children: "Abacus" })] }), _jsx("p", { className: "text-lg text-gray-600", children: "More than just fast calculations\u2014abacus training transforms how children think and learn." })] }), _jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-4 gap-6", children: benefits.map((benefit, index) => (_jsx(motion.div, { initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.5, delay: index * 0.1 }, viewport: { once: true }, children: _jsxs(Card, { className: "p-6 h-full hover:shadow-lg transition-shadow border-0 rounded-2xl", children: [_jsx("div", { className: `${benefit.bgColor} w-14 h-14 rounded-2xl flex items-center justify-center mb-4`, children: _jsx(benefit.icon, { className: `w-7 h-7 ${benefit.color}` }) }), _jsx("h3", { className: "text-xl mb-2 text-gray-900 font-inter-tight", children: benefit.title }), _jsx("p", { className: "text-gray-600", children: benefit.description })] }) }, index))) })] }) }), _jsx("section", { className: "py-16", children: _jsxs("div", { className: "container mx-auto px-4", children: [_jsxs(motion.div, { className: "text-center max-w-3xl mx-auto mb-12", initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.6 }, viewport: { once: true }, children: [_jsxs("h2", { className: "text-3xl md:text-4xl mb-4 text-gray-900 font-clash", children: ["Progressive ", _jsx("span", { className: "text-green-600", children: "Learning Path" })] }), _jsx("p", { className: "text-lg text-gray-600", children: "From basic bead manipulation to lightning-fast mental calculations in three structured levels." })] }), _jsx("div", { className: "max-w-4xl mx-auto space-y-6", children: levels.map((level, index) => (_jsx(motion.div, { initial: { opacity: 0, x: -30 }, whileInView: { opacity: 1, x: 0 }, transition: { duration: 0.5, delay: index * 0.1 }, viewport: { once: true }, children: _jsx(Card, { className: "overflow-hidden border-0 rounded-2xl shadow-lg hover:shadow-xl transition-shadow", children: _jsx("div", { className: `${level.color} p-1`, children: _jsxs("div", { className: "bg-white p-6", children: [_jsxs("div", { className: "flex flex-col md:flex-row md:items-center md:justify-between mb-4", children: [_jsxs("div", { children: [_jsx("h3", { className: "text-2xl mb-2 text-gray-900 font-inter-tight", children: level.title }), _jsxs("div", { className: "flex items-center gap-4 text-gray-600", children: [_jsxs("span", { className: "flex items-center gap-2", children: [_jsx(Clock, { className: "w-4 h-4" }), level.duration] }), _jsxs(Badge, { className: `${level.lightColor} ${level.textColor} border-0`, children: [level.topics.length, " Learning Modules"] })] })] }), _jsx(Button, { className: `${level.color} text-white rounded-full mt-4 md:mt-0`, children: "Enroll Now" })] }), _jsx("div", { className: "grid md:grid-cols-2 gap-3", children: level.topics.map((topic, topicIndex) => (_jsxs("div", { className: "flex items-start gap-2", children: [_jsx(CheckCircle2, { className: `w-5 h-5 ${level.textColor} flex-shrink-0 mt-0.5` }), _jsx("span", { className: "text-gray-700", children: topic })] }, topicIndex))) })] }) }) }) }, index))) })] }) }), _jsx("section", { className: "py-16 bg-gradient-to-br from-green-50 to-blue-50", children: _jsxs("div", { className: "container mx-auto px-4", children: [_jsxs(motion.div, { className: "text-center max-w-3xl mx-auto mb-12", initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.6 }, viewport: { once: true }, children: [_jsxs("h2", { className: "text-3xl md:text-4xl mb-4 text-gray-900 font-clash", children: ["The Abacus ", _jsx("span", { className: "text-green-600", children: "Journey" })] }), _jsx("p", { className: "text-lg text-gray-600", children: "A proven progression from physical tool to pure mental calculation mastery." })] }), _jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto", children: methodology.map((item, index) => (_jsxs(motion.div, { className: "relative", initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.5, delay: index * 0.1 }, viewport: { once: true }, children: [_jsxs(Card, { className: "p-6 text-center border-0 rounded-2xl bg-white shadow-lg h-full", children: [_jsx("div", { className: "text-6xl font-clash text-green-100 mb-4", children: item.step }), _jsx("div", { className: "bg-green-100 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4", children: _jsx(item.icon, { className: "w-8 h-8 text-green-600" }) }), _jsx("h3", { className: "text-xl mb-2 text-gray-900 font-inter-tight", children: item.title }), _jsx("p", { className: "text-gray-600", children: item.description })] }), index < methodology.length - 1 && (_jsx("div", { className: "hidden lg:block absolute top-1/2 -right-3 transform -translate-y-1/2 z-10", children: _jsx(ArrowRight, { className: "w-6 h-6 text-green-300" }) }))] }, index))) })] }) }), _jsx("section", { className: "py-16", children: _jsxs("div", { className: "container mx-auto px-4", children: [_jsxs(motion.div, { className: "text-center max-w-3xl mx-auto mb-12", initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.6 }, viewport: { once: true }, children: [_jsxs("h2", { className: "text-3xl md:text-4xl mb-4 text-gray-900 font-clash", children: ["Whole Brain ", _jsx("span", { className: "text-green-600", children: "Development" })] }), _jsx("p", { className: "text-lg text-gray-600", children: "Abacus activates both left and right hemispheres for complete cognitive growth." })] }), _jsx("div", { className: "grid md:grid-cols-2 gap-6 max-w-5xl mx-auto", children: mentalBenefits.map((benefit, index) => (_jsx(motion.div, { initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.5, delay: index * 0.1 }, viewport: { once: true }, children: _jsx(Card, { className: "p-8 border-0 rounded-2xl hover:shadow-lg transition-shadow", children: _jsxs("div", { className: "flex items-start gap-4", children: [_jsx("div", { className: `${benefit.bgColor} p-3 rounded-2xl flex-shrink-0`, children: _jsx(benefit.icon, { className: `w-6 h-6 ${benefit.color}` }) }), _jsxs("div", { children: [_jsx("h3", { className: "text-xl mb-2 text-gray-900 font-inter-tight", children: benefit.title }), _jsx("p", { className: "text-gray-600", children: benefit.description })] })] }) }) }, index))) })] }) }), _jsx("section", { className: "py-16 bg-gray-50", children: _jsx("div", { className: "container mx-auto px-4", children: _jsx("div", { className: "max-w-5xl mx-auto", children: _jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: [_jsxs(motion.div, { initial: { opacity: 0, x: -50 }, whileInView: { opacity: 1, x: 0 }, transition: { duration: 0.6 }, viewport: { once: true }, children: [_jsxs("h2", { className: "text-3xl md:text-4xl mb-6 text-gray-900 font-clash", children: ["Skills That ", _jsx("span", { className: "text-green-600", children: "Transform" })] }), _jsx("p", { className: "text-lg text-gray-600 mb-8", children: "Regular abacus practice leads to measurable improvements across multiple cognitive areas." }), _jsx("div", { className: "grid grid-cols-2 gap-4", children: skillsImproved.map((skill, index) => (_jsxs(motion.div, { className: "flex items-start gap-2", initial: { opacity: 0, x: -20 }, whileInView: { opacity: 1, x: 0 }, transition: { duration: 0.5, delay: index * 0.1 }, viewport: { once: true }, children: [_jsx(CheckCircle2, { className: "w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" }), _jsx("span", { className: "text-gray-700", children: skill })] }, index))) }), _jsx("div", { className: "mt-8 p-6 bg-green-50 rounded-2xl border-2 border-green-200", children: _jsxs("div", { className: "flex items-start gap-3", children: [_jsx(Trophy, { className: "w-6 h-6 text-green-600 flex-shrink-0" }), _jsxs("div", { children: [_jsx("h4", { className: "text-lg mb-2 text-gray-900 font-inter-tight", children: "Proven Results" }), _jsx("p", { className: "text-gray-600", children: "Research shows abacus students score 15-20% higher in math tests and show significantly improved concentration in all subjects." })] })] }) })] }), _jsx(motion.div, { initial: { opacity: 0, x: 50 }, whileInView: { opacity: 1, x: 0 }, transition: { duration: 0.6 }, viewport: { once: true }, children: _jsx("div", { className: "relative rounded-3xl overflow-hidden shadow-2xl", children: _jsx(ImageWithFallback, { src: "https://images.unsplash.com/photo-1722912010170-704c382ca530?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxraWRzJTIwc3R1ZHlpbmclMjB0b2dldGhlciUyMGdyb3VwfGVufDF8fHx8MTc2MDI1MzgyMXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral", alt: "Students practicing abacus", className: "w-full h-[400px] object-cover" }) }) })] }) }) }) }), _jsx("div", { className: "pricing-section", children: _jsx(PricingTiers, { programName: "Abacus", programColor: "green" }) }), _jsx("section", { className: "py-16", children: _jsxs("div", { className: "container mx-auto px-4", children: [_jsxs(motion.div, { className: "text-center max-w-3xl mx-auto mb-12", initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.6 }, viewport: { once: true }, children: [_jsxs("h2", { className: "text-3xl md:text-4xl mb-4 text-gray-900 font-clash", children: ["Frequently Asked ", _jsx("span", { className: "text-green-600", children: "Questions" })] }), _jsx("p", { className: "text-lg text-gray-600", children: "Common questions about our abacus training program." })] }), _jsx("div", { className: "max-w-3xl mx-auto", children: _jsx(Accordion, { type: "single", collapsible: true, className: "space-y-4", children: faqs.map((faq, index) => (_jsx(motion.div, { initial: { opacity: 0, y: 20 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.5, delay: index * 0.1 }, viewport: { once: true }, children: _jsxs(AccordionItem, { value: `item-${index}`, className: "border-0 bg-white rounded-2xl shadow-md px-6", children: [_jsx(AccordionTrigger, { className: "text-left hover:no-underline py-6", children: _jsx("span", { className: "text-lg text-gray-900 font-inter-tight pr-4", children: faq.question }) }), _jsx(AccordionContent, { className: "text-gray-600 pb-6", children: faq.answer })] }) }, index))) }) })] }) }), _jsx("section", { className: "py-20 bg-gradient-to-br from-green-600 to-blue-700 text-white", children: _jsx("div", { className: "container mx-auto px-4", children: _jsxs(motion.div, { className: "text-center max-w-3xl mx-auto", initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.6 }, viewport: { once: true }, children: [_jsx("h2", { className: "text-3xl md:text-5xl mb-6 font-clash", children: "Unlock Your Child's Mental Superpowers" }), _jsx("p", { className: "text-xl mb-8 text-blue-100", children: "Join thousands of students who can calculate faster than a calculator while developing extraordinary concentration and memory skills." }), _jsx("div", { className: "flex flex-col sm:flex-row gap-4 justify-center", children: _jsxs(Button, { size: "lg", onClick: () => {
                                        const pricingSection = document.querySelector('.pricing-section');
                                        if (pricingSection) {
                                            pricingSection.scrollIntoView({ behavior: 'smooth' });
                                        }
                                    }, className: "bg-orange-500 hover:bg-orange-600 text-white rounded-full px-10", children: ["View Pricing & Enroll", _jsx(ArrowRight, { className: "w-5 h-5 ml-2" })] }) }), _jsx("p", { className: "mt-6 text-sm text-blue-200", children: "Free abacus kit included \u2022 30-day money-back guarantee \u2022 Expert instructors" })] }) }) })] }));
}
